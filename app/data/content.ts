...
export const research: ResearchPaper[] = [
  {
    id: 1,
    title: "Bias in AI-Generated Travel Narratives: Evaluating LLMs in Countering Misconceptions",
    authors: [
      "Anshuman Mohapatra",
      "Ashique Khudabukhsh",
    ...
    venue: "Rochester Institute of Technology, Department of Software Engineering",
    date: "2026",
    abstract:
      "Investigates how bias manifests in AI-generated travel narratives, treating LLMs not as objects of evaluation but as instruments for revealing representational, cultural, and evaluative bias. Compares counterspeech generated by LLaMA 3.2, Gemma 2, GPT-2, and Sarvam across human and automated toxicity assessments, showing that automated scoring consistently underestimates implicit harm and produces unstable model rankings — underscoring the need for context-aware, human-grounded evaluation of generative AI systems.",
    pdfUrl: "/assets/research/bias-in-ai-travel-narratives.pdf",
    pdfFileName: "Bias in AI-Generated Travel Narratives.pdf",
  },
  {
    id: 2,
    title: "Analyzing Social Media Responses Across Various Languages Based On RG Kar Incident",
    authors: ["Sooraj Kakkanatt Manoj", "Yogesh Kuchimanchi"],
    venue: "Rochester Institute of Technology, Department of Data Science",
    date: "2026",
    abstract:
      "Explores the multilingual dynamics of public discourse surrounding the RG Kar Hospital incident using YouTube comments in five languages. Applies VADER sentiment analysis and LDA topic modeling to uncover recurring themes, revealing an unexpected dominance of political discourse and administrative-failure criticism over the initially expected focus on misogyny — highlighting the power of public sentiment analysis in surfacing societal concerns.",
    pdfUrl: "/assets/research/rg-kar-social-media-analysis.pdf",
    pdfFileName: "Analyzing Social Media Responses Across Various Languages Based On RG Kar Incident.pdf",
  },
];
