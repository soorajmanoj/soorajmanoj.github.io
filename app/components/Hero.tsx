    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col-reverse items-start gap-10 px-6 py-24 sm:flex-row sm:items-center sm:justify-between sm:py-32">
        <div className="flex min-w-0 flex-1 flex-col gap-6">
          ...
          <h1 className="whitespace-nowrap font-serif text-4xl font-medium italic tracking-tight sm:text-5xl lg:text-6xl">
            {profile.name}
          </h1>
        ...
        <img
          ...
          alt={profile.name}
          className="h-40 w-40 shrink-0 rounded-full border-4 border-accent/30 object-cover shadow-lg shadow-accent/10 sm:h-56 sm:w-56"
        />
      </div>
    </section>
  );
